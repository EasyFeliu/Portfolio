...
const DEFAULT_DATABASE_PATH = "data/portfolio.db";
...
function resolveDatabasePath(): string {
  ...
  // La ruta es configurable en tiempo de ejecución, así que evitamos que el
  // bundler intente trazar el sistema de ficheros completo.
...
/**
 * Inserta (o actualiza) los proyectos de `data/seed-projects.ts`.
